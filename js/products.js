    ...
    '<article class="product-card">' +
      ...
      '<div class="product-body" style="padding-top: 6px;">' +
        ...
        '<div class="product-foot" style="margin:0 0 8px 0; justify-content:center;">' +
          '<span class="price" style="font-size:1rem; font-weight:900; '<span class="price" style="font-size:1rem; font-weight:900; color:var(--olive-700);">' + formatPrice(product.price) + "</span>" +">' + formatPrice(product.price) + "</span>" +
        "</div>" +
